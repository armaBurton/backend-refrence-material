...
CREATE TABLE dogs (
  ...
  weight TEXT,
  owner_id BIGINT REFERENCES owners(id), -- Only difference from one-to-one is that we removed the UNIQUE constraint here
);
...
-- Add some doggos (need to create owners first)
